...
Or, if you use CC Switch, see [Bridge/CCSwitch-Guide.md](Bridge/CCSwitch-Guide.md) for IDE integration.
...
See [Bridge/CCSwitch-Guide.md](Bridge/CCSwitch-Guide.md) for step-by-step instructions.
